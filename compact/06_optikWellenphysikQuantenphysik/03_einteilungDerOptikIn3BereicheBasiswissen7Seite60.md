---
title: "6.3 Einteilung der Optik in 3 Bereiche (Basiswissen 7, Seite 60)"
tags:
  - "compact"
  - "Physik Mitschrift"
---
...
![img](../media/physik_mitschrift/img_040.png)
...
![img](../media/physik_mitschrift/img_041.png)
...
![img](../media/physik_mitschrift/img_042.png)
...
## Friedl-Ergänzung: Prüfungslogik des Photoeffekts

Der Photoeffekt ist ein zentrales Argument für die Photonenhypothese:

==Nicht die Helligkeit entscheidet, ob Elektronen austreten, sondern die Frequenz des Lichtes.==

Mehr Helligkeit bedeutet im Photonenbild:

$$
\uparrow I \Rightarrow \uparrow N_\gamma
$$

also mehr Photonen pro Zeit. Eine höhere Frequenz bedeutet:

$$
\uparrow f \Rightarrow \uparrow E_\gamma
$$

also energiereichere Photonen.

**Matura-Satz:**  
Sehr helles rotes Licht kann wirkungslos bleiben, während schwaches UV-Licht Elektronen sofort auslöst, weil UV-Photonen einzeln mehr Energie besitzen.
...
$$
E_{kin}=\frac{m_e v^2}{2}
$$

Für die Zahl der ausgesendeten Photonen bei einer Lichtquelle mit Leistung $P$ gilt:

$$
N=\frac{P\cdot t}{h\cdot f}
$$

Weiter mit [Prüfungsfragen und Rechenmuster](./06_pruefungsfragenQuantenphysik.md).
